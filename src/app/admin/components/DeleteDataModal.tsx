    ...
    return (
      ...
      >
        ...
        <div className='grid grid-cols-[1fr,1.5fr] gap-2.5 '>
            <button onClick={handleDelete} className='text-[#1657FF] border border-[#1657FF] bg-white h-[50px] py-2 rounded-[50px] text-xl font-sfproDisplaybold '>{('confirmButton')} </button>
            <button onClick={onClose} className='bg-[#FF16A2] text-white h-[50px] py-2 rounded-[50px] text-xl font-sfproDisplaybold '>{('cancelButton')}</button>
        </div>
    </Modal>
    );
}
